...
$select = mysqli_query($conn, "SELECT * FROM pembayaran
                                INNER JOIN sewa ON sewa.id_sewa=pembayaran.id_sewa
                                INNER JOIN kios ON kios.id_kios=sewa.id_kios
                                INNER JOIN penyewa ON penyewa.id_penyewa=sewa.id_penyewa
                                WHERE id_pembayaran='$id_pembayaran' AND penyewa.id_penyewa='$id_penyewa'");
...
$selectPembayaran = mysqli_query($conn, "SELECT * FROM pembayaran INNER JOIN sewa ON sewa.id_sewa=pembayaran.id_sewa WHERE pembayaran.id_pembayaran='$id_pembayaran'");
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="controller/cetak.php" enctype="multipart/form-data">
                <div class="card-body">
